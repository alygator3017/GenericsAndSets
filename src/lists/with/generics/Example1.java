...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        //generating an iterator from the list
        //iterators have a method called hasNext which is a boolean
        //if the next item is true, it will loop until hasNext returns false
